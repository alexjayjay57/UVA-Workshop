...
export function remainingMinutesInOven(actualMinutesInOven) {
  actualMinutesInOven = EXPECTED_MINUTES_IN_OVEN - actualMinutesInOven;
...
export function preparationTimeInMinutes(numberOfLayers) {
  const minutesPerLayer = PREPARATION_MINUTES_PER_LAYER * numberOfLayers
...
export function totalTimeInMinutes(numberOfLayers, actualMinutesInOven) {
  const totalPreparationTime = numberOfLayers * PREPARATION_MINUTES_PER_LAYER;
